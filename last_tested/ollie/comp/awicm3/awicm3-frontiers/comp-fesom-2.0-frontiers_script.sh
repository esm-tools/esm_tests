...
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH:+${LD_LIBRARY_PATH}:}"$GRIBAPIROOT/lib"
...
export OIFS_GRIB_INCLUDE=-I$GRIBAPIROOT/include
export OIFS_GRIB_LIB="-L$GRIBAPIROOT/lib -lgrib_api_f90 -lgrib_api"
export OIFS_GRIB_API_BIN="$GRIBAPIROOT/bin"
export OIFS_GRIB_BIN="$GRIBAPIROOT/bin"
...
export OIFS_CFLAGS="-fp-model precise -O3 -qopenmp -xCORE_AVX2 -g -traceback -qopt-report=0"
