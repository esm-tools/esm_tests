...
cd xios
export XIOS_TOPLEVEL=/p/scratch/chhb19/mandresm/testing/comp/oifs/oifs-43r3-v1/xios; ./make_xios --arch ESMTOOLS_generic_intel --netcdf_lib netcdf4_par --full  --job 24; cp bin/xios_server.exe bin/xios.x
cd ..
