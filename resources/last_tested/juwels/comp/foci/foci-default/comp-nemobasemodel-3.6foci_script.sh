...
export NEMO_TOPLEVEL=/p/scratch/chhb19/mandresm/testing/comp/foci/foci-default/nemo-ORCA05_LIM2_KCM_AOW; cd CONFIG; cp ORCA05_LIM2_KCM_AOW/cfg.inc cfg.txt; ./makenemo -n ORCA05_LIM2_KCM_AOW -m ESMTOOLS_generic_oasis_intel -j 24; cp -p ORCA05_LIM2_KCM_AOW/BLD/bin/nemo.exe ORCA05_LIM2_KCM_AOW/BLD/bin/oceanx
cd ..
